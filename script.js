document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            labs: "Laboratorios",
            contact: "Contacto",
            subtitle: "Especialista en Ciberseguridad | Certificado Microsoft",
            viewLabs: "Ver Mis Laboratorios",
            contactMe: "Contactar",
            scroll: "Desplazar",
            aboutMe: "// Sobre Mí",
            hello: "¡Hola! Soy",
            aboutText1: "Soy un <span class=\"highlight\">Especialista en Ciberseguridad</span> apasionado y comprometido con la protección de sistemas y datos en el mundo digital.",
        ...
        en: {
            ...
            labs: "Labs",
            contact: "Contact",
            subtitle: "Cybersecurity Specialist | Microsoft Certified",
            viewLabs: "View My Labs",
            contactMe: "Get In Touch",
            scroll: "Scroll",
            aboutMe: "// About Me",
            hello: "Hello! I'm",
            aboutText1: "I'm an <span class=\"highlight\">Systems Engineer</span> specialized in Cibersecurity and systems administration, with a current focus on the field of <span class=\"highlight\">Cybersecurity</span>.",
    ...
    function updateLanguage() {
        ...
        try {
            ...
            if (aboutText) {
                ...
                if (aboutHeading) aboutHeading.innerHTML = `${t.hello} <span class="highlight">Eduardo V. Cabeza A.</span>`;
            ...
            if (footer) {
                ...
                if (footerParagraphs.length >= 2) {
                    footerParagraphs[0].textContent = `© 2025 Eduardo V. Cabeza A. ${t.rights}.`;
